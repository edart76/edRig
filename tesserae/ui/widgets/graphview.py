...
from edRig.tesserae.jchan2 import NodeGraph, Node
from edRig.tesserae.jchan2.base import actions
...
from edRig.tesserae.jchan2.base.vendor import NodeVendor  # i hate it
...
class GraphViewWidget(NodeGraph):
	...
	def _on_connection_changed(self, disconnected, connected,
		...
		# string of edRig.tesserae.jchan2.widgets.port.PortItem("jc")
...
class TPNode(Node):
	# extending base Node class for anything appearing in tesserae view
