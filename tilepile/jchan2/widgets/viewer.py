...
from edRig.tilepile.jchan2.widgets.pipe import Pipe
from edRig.tilepile.jchan2.widgets.port import PortItem
from edRig.tilepile.jchan2.widgets.scene import NodeScene
from edRig.tilepile.jchan2.widgets.stylesheet import STYLE_QMENU
from edRig.tilepile.jchan2.widgets.tab_search import TabSearchWidget
from edRig.tilepile.jchan2.widgets.contextmenu import ContextMenu
...
class NodeViewer(QtWidgets.QGraphicsView):
	...
	node_delete_called = QtCore.Signal()
	...
	def contextMenuEvent(self, event):
		print "viewer contextMenuEvent called"
		self.RMB_state = False
		try:
			self.modify_context_menu(self)
		except RuntimeError("ERROR encountered on context_menu event"):
			pass
	...
	@staticmethod
	def modify_context_menu(*args, **kwargs):
		"""to be overridden at a higher level, intended to allow context
		menu to show different items based on
		well
		context
		"""
		print "viewer base modify_context_menu called"
		pass

	def context_menu(self):
		print "viewer context_menu called"
