...
from edRig.tilepile.jchan2.base.actions import setup_actions
from edRig.tilepile.jchan2.base.commands import (NodeAddedCmd,
                                       NodeRemovedCmd,
                                       NodeMovedCmd,
                                       PortConnectedCmd)
from edRig.tilepile.jchan2.base.model import NodeGraphModel
from edRig.tilepile.jchan2.base.node import NodeObject
from edRig.tilepile.jchan2.base.vendor import NodeVendor
from edRig.tilepile.jchan2.widgets.viewer import NodeViewer
...
class NodeGraph(QtCore.QObject):
    ...
    def viewer(self):
        ...
        Returns:
            edRig.tilepile.jchan2.widgets.viewer.NodeViewer: viewer widget.
        """
        return self._viewer
    ...
    def scene(self):
        ...
        Returns:
            edRig.tilepile.jchan2.widgets.scene.NodeScene: node scene.
        """
    ...
    def context_menu(self):
        ...
        """
        print "graph context_menu called"
    ...
    def center_on(self, nodes=None):
        ...
        Args:
            nodes (list[edRig.tilepile.jchan2.Node]): a list of nodes.
        """
    ...
    def register_node(self, node, alias=None):
        ...
        Args:
            node (edRig.tilepile.jchan2.Node): node object.
    ...
    def create_node(self, node_type, name=None, selected=True, color=None, pos=None):
        ...
        Returns:
            edRig.tilepile.jchan2.Node: created instance of a node.
        """
    ...
    def delete_nodes(self, nodes):
        ...
        Args:
            nodes (list[edRig.tilepile.jchan2.Node]): list of node instances.
        """
    ...
    def all_nodes(self):
        ...
        Returns:
            list[edRig.tilepile.jchan2.Node]: list of nodes.
        """
    ...
    def get_node_by_id(self, node_id=None):
        ...
        Returns:
            edRig.tilepile.jchan2.NodeObject: node object.
        """
    ...
    def get_node_by_name(self, name):
        ...
        Returns:
            edRig.tilepile.jchan2.Node: node object.
        """
    ...
    def _serialize(self, nodes):
        ...
        Args:
            nodes (list[edRig.tilepile.jchan2.Nodes]): list of node instances.
    ...
    def _deserialize(self, data, relative_pos=False, pos=None):
        ...
        Returns:
            list[edRig.tilepile.jchan2.Nodes]: list of node instances.
        """
        nodes = {}
    ...
    def load_session(self, file_path):
        ...
        nodes = self._deserialize(layout_data)
        self._undo_stack.clear()
    ...
    def duplicate_nodes(self, nodes):
        ...
        Args:
            nodes (list[edRig.tilepile.jchan2.Node]): list of node objects.
        Returns:
            list[edRig.tilepile.jchan2.Node]: list of duplicated node instances.
        """
        if not nodes:
            return
