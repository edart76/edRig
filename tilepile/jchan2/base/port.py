#!/usr/bin/python
from edRig.tilepile.jchan2.base.commands import PortConnectedCmd, PortDisconnectedCmd
from edRig.tilepile.jchan2.base.model import PortModel
...
class Port(object):
    ...
    def __init__(self, node, port):
        """
        Args:
            node (edRig.tilepile.jchan2.NodeObject): parent node object.
            port (edRig.tilepile.jchan2.widgets.port.PortItem): port view item.
        """
        self.__view = port
    ...
    def node(self):
        ...
        Returns:
            edRig.tilepile.jchan2.NodeObject: parent node object.
        """
    ...
    def connected_ports(self):
        ...
        Returns:
            list[edRig.tilepile.jchan2.Port]: list of connected ports.
        """
        ports = []
